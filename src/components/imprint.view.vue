...
<template>
	<div class="container">
		...
		<div lang="de">
			...
			<p>
				<a href="https://www.oeaw.ac.at">Österreichische Akademie der Wissenschaften</a>
				<br />
				...
				<br />
				E-Mail:
				<a href="mailto:acdh-tech@oeaw.ac.at">acdh-tech@oeaw.ac.at</a>
			</p>
			<p></p>

			<h3>Unternehmensgegenstand:</h3>
			<p>
				Die Österreichische Akademie der Wissenschaften (ÖAW) hat den gesetzlichen Auftrag, die
				Wissenschaft in jeder Hinsicht zu fördern. Als Gelehrtengesellschaft pflegt die ÖAW den
				Diskurs und die Zusammenarbeit der Wissenschaft mit Öffentlichkeit, Politik und Wirtschaft.
				<br />
				Das Austrian Centre for Digital Humanities and Cultural Heritage (ACDH-CH) ist ein Institut
				der ÖAW, das mit dem Ziel gegründet wurde, digitale Methoden und Ansätze in den
				geisteswissenschaftlichen Disziplinen zu fördern. Das ACDH-CH unterstützt digitale Forschung
			...
			<p>
				...
				<a href="https://www.oeaw.ac.at/oeaw/gremien/akademierat/">
					https://www.oeaw.ac.at/oeaw/gremien/akademierat/
				</a>
			</p>
			<h3>Grundlegende Richtung:</h3>
			<p>
				Diese Webseite widmet sich der Bereitstellung der aus diesem Projekt hervorgehenden
				Ergebnisse.
			</p>
			<h3>Haftungsausschluss:</h3>
			<p>
				Die Österreichische Akademie der Wissenschaften übernimmt keinerlei Gewähr für die
				Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten Informationen.
				<br />
				Im Falle des Bestehens von Links auf Webseiten anderer Medieninhaber, für deren Inhalt die
				ÖAW weder direkt oder indirekt mitverantwortlich ist, übernimmt die ÖAW keine Haftung für
				deren Inhalte und schließt jegliche Haftung hierfür aus.
			</p>
			<h3>Urheberrechtlicher Hinweis:</h3>
			<p>
				Diese Seite und ihre Inhalte sind, sofern nicht anders gekennzeichnet, unter der creative
				commons Lizenz
			...
			<p>
				...
				Herkunft nach Land, wievielter Besuch seit Beginn der Aufzeichnung) mittels Matomo-Tracking
				...
				Datenverarbeitung einverstanden. Durch eine entsprechende Einstellung in Ihrem Browser
				...
				<a href="https://www.oeaw.ac.at/die-oeaw/datenschutz/">hier</a>
				...
				verwendet werden. Einer derartigen Verwendung wird hiermit ausdrücklich widersprochen.
			</p>
		</div>
	</div>
</template>
